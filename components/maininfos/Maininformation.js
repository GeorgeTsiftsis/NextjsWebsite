    ...
    <div className={classes.bigdiv}>
      <div className={classes.containerr}>
        <p className={classes.text_intro}>
          ...
          Ο σύλλογός μας με την επωνυμία ΄΄Α.Γ.Σ. ΚΟΖΑΝΗΣ ΜΑΚΕΔΟΝΙΚΗ ΔΥΝΑΜΗ’’ ιδρύθηκε το 1988. Εδώ και 33 χρόνια λοιπόν δραστηριοποιείται στα αθλήματα του taekwondo, της ενόργανης και της ρυθμικής γυμναστικής. Επίσης, απασχολεί στις τάξεις του, 10 γυμναστές και προπονητές των αντίστοιχων ειδικοτήτων.
Το  1990 έγινε μέλος της Ελληνικής  Ομοσπονδίας  Τάεκβοντο (ΕΛ.Ο.Τ) και από τότε έως και σήμερα έχει να παρουσιάσει πληθώρα δραστηριοτήτων και επιτυχιών, τόσο σε επαρχιακό, σε πανελλήνιο όσο και σε διεθνές επίπεδο που καθιστούν τον σύλλογό μας επάξια σε έναν από τους πιο οργανωμένους και πρωτοποριακούς συλλόγους της χώρας μας. Μετράει στο ενεργητικό του 6 Παγκόσμιες διακρίσεις, 15 Πανευρωπαϊκές, 2 Μεσογειακές, 2 Βαλκανικές και 350 Πανελλήνια μετάλλια!
