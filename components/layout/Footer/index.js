      ...
      <footer>
        <div className={classes.container}>
          ...
          <div className={classes.socialmediacontainer}>
            <a target="_blank" rel="noopener noreferrer" passHref href="https://www.facebook.com/profile.php?id=100063686376902" style={{ padding: 5 }}>
              <FaFacebook className={classes.fab} />
            </a>
            <a target="_blank" rel="noopener noreferrer" passHref href="https://www.instagram.com/macedonian_force/" style={{ padding: 5 }}>
