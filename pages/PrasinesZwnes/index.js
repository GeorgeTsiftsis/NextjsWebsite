...
function index(props) {
  return (
    <>
    <Head>
      <title> Α.Σ. Μακεδονική Δύναμη Κοζάνης Τμήματα Πράσινων ζωνών </title>
      <meta name="description" content="Τμήματα πράσινων ζωνών παιδιά στην Μακεδονική Δύναμη Κοζάνης." />
    </Head>
    <motion.section initial="hidden" animate="enter" exit="exit" variants={variants} transition={{ type: "linear" }}>
    <HorizontalLine title={"Τμήματα Πράσινων ζωνών"}  />
