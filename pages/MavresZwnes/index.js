...
function index(props) {
  return (
    <>
    <Head>
      <title> Α.Σ. Μακεδονική Δύναμη Κοζάνης Τμήματα Μαύρων ζωνών </title>
      <meta name="description" content="Τμήματα μαύρων ζωνών ταε-κβον-ντο" />
    </Head>
    <motion.section initial="hidden" animate="enter" exit="exit" variants={variants} transition={{ type: "linear" }}>
    <HorizontalLine title={"Τμήματα Μαύρων Ζωνών"}  />
