      ...
      <motion.section style={{ backgroundColor: "#6096ba" }} initial="hidden" animate="enter" exit="exit" variants={variants} transition={{ type: "linear" }}>
        ...
        <div className={classes.container_details_contact}>
          <p className={classes.text_details}>
            Η έδρα του συλλόγου βρίσκεται επί της οδού Εστίας 3, ΤΚ 50131 Κοζανη. Επικοινωνήστε μαζί μας για οποιαδήποτε πληροφορία/απορία   μέσω της παρακατω φόρμας η μπορειτε να μας καλέσετε στο <strong style={{ display: "block" }}>Σταθερό: 24610 25054</strong> <strong> Κινητό: 6946504020</strong>.{" "}
          </p>
        </div>
