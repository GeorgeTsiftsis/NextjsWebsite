...
function index(props) {
  return (
    <>
    <Head>
      <title> Α.Σ. Μακεδονική Δύναμη Κοζάνης Ρυθμική Γυμναστική </title>
      <meta name="description" content="Τμήματα ρυθμικής Γυμναστικής για παιδιά" />
    </Head>
    <motion.section initial="hidden" animate="enter" exit="exit" variants={variants} transition={{ type: "linear" }}>
    <HorizontalLine title={"Ρυθμική Γυμναστική"}  />
