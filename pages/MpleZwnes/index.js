...
function index(props) {
  return (
    <>
    <Head>
      <title> Α.Σ. Μακεδονική Δύναμη Κοζάνης Τμήματα Μπλέ ζωνών </title>
      <meta name="description" content="Τμήματα μπλέ ζωνών ταε-κβον-ντο στην Μακεδονική Δύναμη Κοζάνης" />
    </Head>
    <motion.section initial="hidden" animate="enter" exit="exit" variants={variants} transition={{ type: "linear" }}>
    <HorizontalLine title={"Τμήματα Μπλέ ζωνών"}  />
