...
function index(props) {
  return (
    <>
    <Head>
      <title> Α.Σ. Μακεδονική Δύναμη Κοζάνης Τμήματα Κίτρινων ζωνών </title>
      <meta name="description" content="Τμήματα Κίτρινων ζωνών Ταε-Κβον-Ντο" />
    </Head>
    <motion.section initial="hidden" animate="enter" exit="exit" variants={variants} transition={{ type: "linear" }}>
    <HorizontalLine title={"Τμήματα Κίτρινων ζωνών"}  />
