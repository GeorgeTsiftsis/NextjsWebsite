...
function index(props) {
  return (
    <>
    <Head>
      <title> Α.Σ. Μακεδονική Δύναμη Κοζάνης Αίθουσες Αθλητικός και Μοντέρνος Χορός </title>
      <meta name="description" content="Τμήματα Αθλητικού και Μοντέρνου Χορού παιδιά" />
    </Head>
    <motion.section initial="hidden" animate="enter" exit="exit" variants={variants} transition={{ type: "linear" }}>
    <HorizontalLine title={"Αθλητικός και Μοντέρνος Χορός"}  />
...
export async function getStaticProps() {
  const imageUrls = await firebase
    .storage()
    .ref("TmimataXorou/AthlitikosModernosXoros")
    .listAll()
    .then((result) => {
